...
contract DvVisitorTicketFactory is DvFactory {
    ...
    function issue(string memory name, string memory symbol) public payable isActive returns (address)
    {
        // take royalty
        ...
        // issue token
        DvVisitorTicket token = new DvVisitorTicket(name, symbol, _msgSender(), address(this));
